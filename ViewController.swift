...
//  ARProject
//
//  Created by Jim Theodoropoulos on 27/3/20.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for node in sceneView.scene.rootNode.childNodes {
            let moveShip = SCNAction.moveBy(x: 0, y: 0.5, z: 0.5, duration: 1) // use - to maake to move further
            ...
            let repearForever = SCNAction.repeatForever(moveShip)
